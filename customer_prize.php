...
<div class="action_icon">
  <img src="img/iconfinder_b-42_4229852.png" alt="project list icon" class="img-fluid mb-2">
    ...
    <select class="form-control" id="prize_id" required name="prize_id">
    ...
    <div class="form-group">
      ...
      <button class="btn btn-md btn-success" id="draw" type="button">Draw</button>
    <button type="submit" class="btn btn-primary" id="btn_draw">Save</button>
    </form>
</div>
<script>
$('#draw').click(function(){
